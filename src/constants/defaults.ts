...
/** Heart rate below this value (bpm) is physiologically implausible. */
export const MIN_HEART_RATE_BPM = 20;
/** Heart rate above this value (bpm) is physiologically implausible. */
